<template>
    <el-row :gutter="10">
        <el-menu router :default-active="activeIndex" class="el-menu-demo" mode="horizontal" background-color="#eee" active-text-color="#009a61" @select="handleSelect">
            <el-col :xs="24" :sm="24" :md="4" :lg="4" :xl="1">
            ...
            <el-col :xs="12" :sm="12" :md="2" :lg="2" :xl="11"><el-menu-item index="/">首页</el-menu-item></el-col>
            <el-col :xs="12" :sm="12" :md="2" :lg="2" :xl="11"><el-menu-item index="/about">关于我</el-menu-item></el-col>
            <el-col v-if="user!==''" :xs="12" :sm="12" :md="2" :lg="2" :xl="1"><el-menu-item index="/createarticlepage">写文章</el-menu-item></el-col>
            <el-col v-if="user!==''" :xs="12" :sm="12" :md="2" :lg="2" :xl="1"><el-menu-item index="/managehome">管理屋</el-menu-item></el-col>
            <el-col :xs="24" :sm="{span: 16, offset: 2}" :md="{span: 4, offset: 0}" :lg="{span: 4, offset: 0}" :xl="1" style="padding-top:8px">
              <el-input
                placeholder="请输入内容"
                v-model="text"
          ...
          <div v-if="user!==''">
            <el-col :xs="{span: 5, offset: 8}" :sm="{span: 2, offset: 1}" :md="2" :lg="{span: 1, offset: 3}" :xl="1" style="height:56px;text-align:center;"><el-avatar shape="square" :size="56" :src="avtarUrl"></el-avatar></el-col>
          ...
          <div v-else>
            <el-col :xs="12" :sm="{span: 2, offset: 0}" :md="{span: 2, offset: 3}" :lg="{span: 2, offset: 3}" :xl="1"><el-menu-item index="/signin" >登录</el-menu-item></el-col>
            <el-col :xs="12" :sm="2" :md="2" :lg="2" :xl="11" ><el-menu-item index="/signup"><span style="border-radius:4px;background-color:#009a61;padding:15px 25px;color:white;">注册</span></el-menu-item></el-col>
          </div>
        </el-menu>
    </el-row>
</template>
